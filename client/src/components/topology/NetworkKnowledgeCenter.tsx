...
import { DNSResolver } from '../protocols/DNSResolver';
import { ARPResolver } from '../protocols/ARPResolver';
import { TCPFlowControl } from '../protocols/TCPFlowControl';
import { FullTransmission } from './FullTransmission';
...
interface NetworkKnowledgeCenterProps {
  defaultModule?: string;
}

export const NetworkKnowledgeCenter: React.FC<NetworkKnowledgeCenterProps> = ({
  defaultModule = 'transmission'
}) => {
...
export default NetworkKnowledgeCenter;
